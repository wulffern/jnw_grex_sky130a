...
C {JNW_TR_SKY130A/JNWTR_IVX2_CV.sym} 430 -210 0 0 {name=x5 }
C {devices/opin.sym} 790 -210 2 1 {name=p20 lab=DO_1V8}
C {JNW_TR_SKY130A/JNWTR_NRX1_CV.sym} 560 -20 0 0 {name=x6 }
...
C {JNW_TR_SKY130A/JNWTR_IVX2_CV.sym} 610 -210 0 0 {name=x7 }
